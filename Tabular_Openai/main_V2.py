...
'''
    Important Table creation for each algorithm 
'''
    ...
    for episode in range(params.EPISODES + 1):
        ...
        #while t < MAX_STEPS:
            ...
            if not done:
                ...
                q_table[discrete_state + (action,)] = params.REWARD_END 
