...
Main3x1 stands for:
    ...
    - 3 hyperparameter: 
            ...
            * epsilon decay, to control exploration rate. When epsilon decay is bigger, exploration lasts a few steps
...
QLearning_stats = {
    'episode': [], 'learning_rate': [], 'best_value': [], 'discount': [], 'epsilondecay': []
}
SARSA_stats = {
    'episode': [], 'learning_rate': [], 'best_value': [], 'discount': [], 'epsilondecay': []
}
                ...
                for episode in range(params.EPISODES+1):
                    ...
                    if params.get_bestValue() < episode_reward:
                            ...
                            if agent == qLearningAgent:
                                ...
                                QLearning_stats['epsilondecay'].append(epsilondecay) 
